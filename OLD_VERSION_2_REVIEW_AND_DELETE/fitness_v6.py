...
def main():
    ...
    # Add the title image with CSS to scale it down by 25%
    st.markdown(
        """
        <style>
        .title-image {
    ...
    st.image("titlepage.jpeg", use_column_width=True, caption="AI-Powered Fitness & Nutrition Coach", output_format="JPEG")
